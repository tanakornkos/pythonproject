...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton = QtWidgets.QPushButton(self.calendar_page)
...
#get date from wicalendon
    def onDateChanged(self, qDate):
        self.ondate = ('{0}/{1}/{2}'.format(qDate.day(), qDate.month(), qDate.year()))
        return self.ondate
    def getdatedata(self, qDate):
        self.getdate = ('{0}/{1}/{2}'.format(qDate.day(), qDate.month(), qDate.year()))
        return self.getdate
